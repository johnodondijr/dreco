...
function renderHelpPage(){
  ...
  el.innerHTML=`<div class="settings-page-card"><h3>Daily workflow</h3><p>Use Dashboard for an overview, Pipeline to move candidates through stages, and Reports for management review.</p><div class="setting-row"><span>Pipeline</span><button data-action="tab.switch" data-tab="pipeline">Open</button></div></div><div class="settings-page-card"><h3>Records</h3><p>Professional Jobs and General Jobs are separate workflows. Travel combines both lists and sorts latest travel first.</p><div class="setting-row"><span>Candidates</span><button data-action="tab.switch" data-tab="candidates">Open</button></div></div><div class="settings-page-card"><h3>Finance</h3><p>Commissions focus on professional job income. Repayments only track travelled general-job clients. Expenses capture money spent on clients.</p><div class="setting-row"><span>Commission payments</span><button data-action="tab.switch" data-tab="payments">Open</button></div><div class="setting-row"><span>Finance summary</span><button data-action="tab.switch" data-tab="finance">Open</button></div></div><div class="settings-page-card"><h3>Support note</h3><p>For shared multi-user work, keep Supabase configured. Local mode is useful for solo testing, but cloud mode is better for office use.</p><div class="setting-row"><span>Settings</span><button data-action="tab.switch" data-tab="settings">Open</button></div></div>`;
}
